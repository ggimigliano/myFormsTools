		...
		case 'get_file': // preview or edit
			...
			if ($sub_action == 'preview')
			{
				if ($preview_mode == 'text')
				{
					...
					$data =\Gimi\myFormsTools\PckmyUtils\PHP8::htmlspecialchars(htmlspecialchars_decode($data));
					$ret = '';
				...
				$data = stripslashes(\Gimi\myFormsTools\PckmyUtils\PHP8::htmlspecialchars(file_get_contents($selected_file)));
