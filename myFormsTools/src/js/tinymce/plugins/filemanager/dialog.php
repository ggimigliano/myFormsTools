...
if(PHP_VERSION<'7.3')
                           setcookie('last_position',$subdir,time() + (86400 * 7),dirname($_SERVER['REQUEST_URI']).'; SameSite=Strict',strstr($_SERVER['HTTP_HOST'],'.'),$_SERVER['HTTPS']=='on',true);
                  else     setcookie('last_position',$subdir,array (
                                                                      'expires' => time() + (86400 * 7),
                                                                      'path' => dirname($_SERVER['REQUEST_URI']),
                                                                      'domain' => strstr($_SERVER['HTTP_HOST'],'.'), // leading dot for compatibility or use subdomain
                                                                      'secure' => $_SERVER['HTTPS']=='on',     // or false
...
$files=$sorted;
$img_type; $attr;$no_thumb;$fileCurrentNum;$foldersCurrentCount;
?>
<!-- header div start -->
