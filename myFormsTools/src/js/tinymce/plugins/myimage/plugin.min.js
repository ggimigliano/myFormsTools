...
Con
			...
			values:
					[
					{text: 'None', value: ''},
					{text: 'Align right', value: 'float:right'},
					{text: 'Align left',  value: 'float:left'}
					]
					
Per avere menu a tendina che sceglie allineamento dx e sx
...
con
if ( data.src && (!data.alt || data.alt.replace(/^\s+|\s+$/gm,'').length<4)  ) {
				data.alt = '';
				alert('Inserire descrizione immagine valida');
				return false;
			}

Per obbligare descrizione immagine     
 */
