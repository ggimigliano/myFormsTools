<?php
namespace Gimi\myFormsTools\PckmyImap;
	...
	class myImapMail
	{
		public $host;  // host like 127.0.0.1 or mail.yoursite.com
		public $port;  // port default is 110 or 143
		public $user;  // user for logon
		public $password;  // user paswword
		public $state;   // variable define diffrent state of connection
		public $connection; // handle to a open connection
		 ...
		 public function get_list($flag)
		{
			...
			$response=preg_split("@$flag@USi",$response);
      ...
      the connection. */
	   ...
	   mailbox can be accessed. */ 
		 ...
		 public function rename_mailbox($old_mailbox_name,$new_mailbox_name)
		{
			...
			return "Mailbox {$old_mailbox_name} deleted.";
		}
      ...
      responses are sent.
		...
		*/
		 ...
		 public function search_mailbox($search_cri,$charset="")
		{
			...
			$search_cri =trim((string) $search_cri);
