...
";
	...
	*/
	 ...
	 *    $db->Execute($stmt);
	 *
	 * @param $stmt OBJECT Statement returned by {@see Prepare()} or {@see PrepareSP()}.
	 * @param $var  STRING PHP variable to bind to
	 * @param $name string Name of stored procedure variable name to bind to.
