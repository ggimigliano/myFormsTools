...
class MIMEDECODE 
	{
	    ...
	    */
	     ...
	     * 
	     */
	     public function decode($params = null,$recursive)
	    {
	        ...
	        if (isset($content_type)) {
	            switch (trim(strtolower($content_type['value']))) {
	                case 'text/plain':
	                    ...
	                    !$return->disposition || $this->_include_bodies===true ||  $this->_include_bodies== $return->disposition ? $return->body = ($this->_decode_bodies ? $this->_decodeBody($body, $encoding) : $body) : null;
	                    break;
	                case 'text/html':
	                    $encoding = isset($content_transfer_encoding) ? $content_transfer_encoding['value'] : '7bit';
	                    !$return->disposition || $this->_include_bodies===true ||  $this->_include_bodies== $return->disposition  ? $return->body = ($this->_decode_bodies ? $this->_decodeBody($body, $encoding) : $body) : null;
	                ...
	                default:
	                    if(!isset($content_transfer_encoding['value']))
	                        ...
	                        !$return->disposition || $this->_include_bodies===true ||  $this->_include_bodies== $return->disposition  ? $return->body = ($this->_decode_bodies ? $this->_decodeBody($body, $content_transfer_encoding['value']) : $body) : null;
	                    break;
	            }
