...
class PHPMailer
{
    ...
    public function preSend()
    {
        try {
            ...
            if (!empty($this->DKIM_domain)
                ...
                $this->MIMEHeader = rtrim((string) $this->MIMEHeader, "\r\n ") . self::CRLF .
    ...
    public function smtpConnect($options = array())
    {
        ...
        foreach ($hosts as $hostentry) {
            $hostinfo = array();
            if (!preg_match('/^((ssl|tls):\/\/)*([a-zA-Z0-9\.-]*):?([0-9]*)$/', trim((string) $hostentry), $hostinfo)) {
    ...
    public function createHeader()
    {
        ...
        $result .= $this->addrAppend('From', array(array(trim((string) $this->From), $this->FromName)));
    ...
    {
        return rtrim((string) $this->MIMEHeader . $this->mailHeader, "\n\r") . self::CRLF . self::CRLF . $this->MIMEBody;
    }
